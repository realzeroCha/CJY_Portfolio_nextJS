...
export const HeaderContent = tw.button`text-3xl leading-9 font-extrabold font-['Apple_SD_Gothic_Neo','Malgun_Gothic','Noto_Sans_CJK_KR',sans-serif]
  [-webkit-text-stroke:1px_black] dark:[-webkit-text-stroke:1px_white] text-transparent hover:[-webkit-text-stroke:1px_#228b22]
  sm:text-base sm:leading-6 sm:w-15 sm:right-[4%]
`;
