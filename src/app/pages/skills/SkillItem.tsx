...
const SkillItemImg = tw.img`p-2 object-contain rounded-lg bg-white w-20 h-20 sm:p-4 sm:w-28 sm:h-28`;
const SkillItemCaption = tw.h5`text-[0.75rem] text-center font-semibold sm:text-[1rem]`;
