...
const HeaderTitle = tw.button`cursor-pointer font-semibold text-gray-150 text-[1rem] font-SB_Aggro_M hover:text-[#228b22] sm:text-[1.25rem]`;
const HeaderItemWrap = tw.div`flex gap-4 sm:gap-8`;
const HeaderContent = tw.button`cursor-pointer font-semibold text-gray-150 font-SB_Aggro_L hover:text-[#228b22] text-[0.75rem] sm:text-[1rem]`;
