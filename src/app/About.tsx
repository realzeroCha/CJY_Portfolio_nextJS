...
const AboutItem = tw.div`flex-1 min-w-[50vw] shadow-md border-[1px] border-[#bbbbbb] dark:border-white flex items-center gap-3 p-4 bg-white black:bg-[#222222] rounded-[5] text-[#333333] sm:flex-none text-[0.9rem] sm:text-[1rem]`;
const AboutItemLink = tw.a`flex-1 min-w-[50vw] shadow-md border-[1px] border-[#bbbbbb] dark:border-white flex items-center gap-3 p-4 bg-white black:bg-[#222222] rounded-[5] text-[#333333] hover:text-[#228b22] transition-none sm:flex-none text-[0.9rem] sm:text-[1rem]`;
const AboutImage = tw.img`rounded-full bg-white w-6 h-6 sm:w-8 sm:h-8`;
